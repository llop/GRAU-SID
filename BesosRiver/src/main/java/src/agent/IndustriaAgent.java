 ...
 * @author llop
 */
public class IndustriaAgent extends BaseAgent {
  
  
  public IndustriaAgent(Individual individual) {
    super(individual);
  }
  ...
  @Override public void action() {
    ...
    List<String> funcNames = getFuncNames(Constants.AGUA_SUCIA_INDUSTRIA);
  ...
  public void aguaSuciaIndustriaNormal() {
    System.out.println();
    ...
    System.out.println("La industria "+individual.getLocalName()+" ha generado suciedad");
    aguaSuciaIndustria(aguaSucia);
    
  }
  
  public void aguaSuciaIndustriaMucho() {
    System.out.println();
    
    ProcesadoraDeAgua procesadora = (ProcesadoraDeAgua)ReflectionUtils.castIndividual(individual, ProcesadoraDeAgua.class);
    MasaDeAgua aguaSucia = procesadora.toMasaDeAgua();
    aguaSucia.Volumen *= 2f;
    System.out.println("La industria "+individual.getLocalName()+" ha generado mucha suciedad");
    aguaSuciaIndustria(aguaSucia);
